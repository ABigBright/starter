...
-- window move
vim.keymap.set({"n"}, "<leader>1", "<cmd>1wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>2", "<cmd>2wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>3", "<cmd>3wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>4", "<cmd>4wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>5", "<cmd>5wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>6", "<cmd>6wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>7", "<cmd>7wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>8", "<cmd>8wincmd w<cr>", {silent = true})
vim.keymap.set({"n"}, "<leader>9", "<cmd>9wincmd w<cr>", {silent = true})
